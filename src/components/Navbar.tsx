          ...
          <div className="hidden lg:flex items-center gap-3">
            {isLoggedIn ? (
              <div className="flex items-center gap-3 border-l border-slate-100 pl-4">
                <Link to="/my-events" className="text-xs font-bold text-slate-500 hover:text-emerald-600 transition-colors uppercase tracking-wider">
                  My Tickets
                </Link>
                <span className="text-slate-200">|</span>
                <Link to="/organizer" className="text-xs font-bold text-slate-500 hover:text-emerald-600 transition-colors uppercase tracking-wider">
                  Organizer Portal
                </Link>
                <span className="text-slate-200">|</span>
              ...
              {isLoggedIn ? (
                <div className="flex flex-col gap-3 pt-1">
                  <Link
                    to="/my-events"
                    onClick={() => setMobileMenuOpen(false)}
                    className="flex items-center gap-3 px-4 py-2.5 hover:bg-slate-50 rounded-xl text-slate-700 font-bold text-sm"
                  >
                  ...
                  <hr className="border-slate-100/85 my-0.5" />
                  <Link
                    to="/profile"
                    onClick={() => setMobileMenuOpen(false)}
